...
| Accessibility | Prototype | Static/code audit targets WCAG 2.2 AAA. `docs/MANUAL-VALIDATION.md` defines the signed human test matrix, but every screen-reader, keyboard, reflow, forced-colors, and Spanish-pronunciation row remains `not_run`. |
