...
with fabricated values. Neither surface implements live parcel retrieval or
the planned document-aware, persisted permit-readiness packet for a real
application.
