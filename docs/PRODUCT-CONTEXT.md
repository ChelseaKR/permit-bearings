...
3. **Verification strength remains underspecified.** Explanation records bind
   ...
   `machine_linked` — the ledger has no real promoted entry to point to, no
   independent signature, and no browser or CLI surface yet.
