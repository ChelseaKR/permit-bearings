...
def _load_mapping_provenance(  # noqa: C901 - schema validation stays fail-closed
    value: Any,
...
def load_readiness_workflow(  # noqa: C901 - whole-record validation is atomic
    path: Path,
    sources_path: Path,
    *,
...
def load_readiness_packet(  # noqa: C901 - whole-record validation is atomic
    path: Path,
    workflow: ReadinessWorkflow,
    *,
    today: date | None = None,
...
def load_readiness_remedies(  # noqa: C901 - whole-record validation is atomic
    path: Path,
    workflow: ReadinessWorkflow,
    *,
    today: date | None = None,
...
def evaluate_readiness(  # noqa: C901 - explicit states remain in one evaluator
    workflow: ReadinessWorkflow,
    packet: ReadinessPacket,
    *,
    today: date | None = None,
